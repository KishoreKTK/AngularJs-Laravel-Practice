...
bookWishlistAppControllers.controller('LoginController', ['$scope', '$http', 'userService', function ($scope, $http) {
...
bookWishlistAppControllers.controller('SignupController', ['$scope', '$http', 'userService', function ($scope, $http) {
